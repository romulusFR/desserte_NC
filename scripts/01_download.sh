...
wget --output-document $DATA/Exploitation_minière_centres_miniers.zip "https://opendata.arcgis.com/api/v3/datasets/464a23302d6a473a9188ab8e26684206_1/downloads/data?format=shp&spatialRefId=3163"
